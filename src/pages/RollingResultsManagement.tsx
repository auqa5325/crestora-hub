...
const RollingResultsManagement = () => {
  const { user } = useAuth();
  ...
  const { data: uploadedFiles, isLoading: filesLoading, refetch: refetchFiles } = useQuery<UploadedFile[]>({
    queryKey: ['rolling-results-files'],
    queryFn: async () => {
      const result = await apiService.getRollingResultsFiles();
  ...
  const uploadCsvMutation = useMutation({
    mutationFn: ({ file, eventId }: { file: File; eventId: string }) => apiService.uploadRollingResultsCsv(file, eventId),
    onSuccess: () => {
    ...
    onError: (error: any) => {
      setUploadingFile(false);
      const errorMessage = error?.message || error?.response?.data?.detail || "Failed to upload CSV. Please try again.";
      toast.error(errorMessage);
    },
  });
  ...
  const deleteFileMutation = useMutation({
    mutationFn: (fileKey: string) => apiService.deleteRollingResultsFile(fileKey),
    onSuccess: () => {
  ...
  const handleCsvUpload = () => {
    ...
    uploadCsvMutation.mutate({ file: selectedFile, eventId: uploadEventId });
  };
      ...
      <DashboardLayout>
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold mb-2">Rolling Results Management</h1>
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="flex flex-col space-y-4 lg:flex-row lg:items-center lg:justify-between lg:space-y-0">
          <div>
            <h1 className="text-2xl font-bold mb-2 sm:text-3xl">Rolling Results Management</h1>
            <p className="text-muted-foreground text-sm sm:text-base">
              Manage winners, runners-up, and CSV uploads for rolling events
            </p>
          </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Manage CSV files uploaded for rolling events
            </CardDescription>
          </CardHeader>
          <CardContent>
            {filesLoading ? (
                  ...
                  <div key={file.key} className="flex items-center justify-between p-3 border rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {file.eventName} • {formatFileSize(file.size)} • {new Date(file.lastModified).toLocaleDateString()}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                      <Button
                        size="sm"
                        variant="outline"
                        onClick={() => window.open(`https://crestora-uploads.s3.ap-south-1.amazonaws.com/${file.key}`, '_blank')}
                      >
              ...
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground mb-4">
                  Upload CSV files to manage rolling event results in bulk.
                </p>
          ...
          <Card>
            <CardContent className="p-4 sm:p-6 text-center">
              ...
              <p className="text-muted-foreground mb-4 text-sm sm:text-base">
                Start by adding results for rolling events or uploading CSV files.
              </p>
              <div className="flex flex-col sm:flex-row gap-2 justify-center">
                ...
                <Button onClick={() => setIsUploadModalOpen(true)} size="sm" variant="outline">
                  <Upload className="h-4 w-4 mr-2" />
                  Upload CSV
                </Button>
              </div>
        ...
        <Dialog open={isUploadModalOpen} onOpenChange={setIsUploadModalOpen}>
          <DialogContent className="max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                Upload any CSV file for the selected rolling event
              </DialogDescription>
            </DialogHeader>
            
            <div className="space-y-4">
              <div>
                <Label htmlFor="upload-event-select">Select Event</Label>
              ...
              <div className="bg-blue-50 p-3 rounded-lg">
                ...
                <ul className="text-sm text-blue-800 space-y-1">
                  ...
                  <li>• File will be uploaded to: rollingresults/{uploadEventId}/</li>
                  <li>• Any CSV content format is supported</li>
                </ul>
              </div>
            </div>
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button 
                ...
                disabled={uploadingFile || !selectedFile || !uploadEventId}
        ...
        {/* Create Result Modal - Same as before */}
        ...
        {/* Edit Result Modal - Same as before */}
...
export default RollingResultsManagement;
